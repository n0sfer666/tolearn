...
Крейт `speech` и команды `speech_*` живут без потребителя до диктовки в поле
ответа письменного зачёта (S141), и ручной прогон вернётся вместе с ней. Распознавание само по себе
