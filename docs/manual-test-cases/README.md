...
Короткий список того, что ждёт проверки прямо сейчас, — [now.md](now.md).
...
- Кейс не трогает то, что уже закрыто автотестом, — только наблюдаемое поведение
  на живом окружении.
- Исключение из «один файл — один кейс» здесь одно: [now.md](now.md). Это не
  кейс, а живой список того, что ждёт проверки прямо сейчас; он ссылается на
  кейсы и меняется по ходу работы.
...
| Файл | О чём |
|---|---|
| [now.md](now.md) | не кейс: живой список того, что ждёт ручной проверки прямо сейчас, со ссылками на кейсы ниже |
...
| [ui/01-screens.md](ui/01-screens.md) | все экраны собранного приложения в светлой и тёмной теме и на ширине 640 px |
| [ui/02-keyboard.md](ui/02-keyboard.md) | клавиатура без мыши: порядок обхода, `/`, слой ⌘K, лестница `Esc`, слой подтверждения |
| [ui/03-fonts-offline.md](ui/03-fonts-offline.md) | шрифты при выключенной сети: Literata и курсив, Golos Text, моноширинный, без вспышки запасного |
