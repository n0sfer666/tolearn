...
export const en: Dictionary = {
  ...
  sweep: {
    ...
    lead: "Questions from passed topics are mixed — one at a time from each topic.",
    open: "Program-wide exam",
    start: "Start the run",
    topics: "Topics in the run",
    pool: "Topics up for review",
    due: "due",
    overdue: "overdue",
    empty: "No passed topics with questions yet — there is nothing to run.",
    legs: "Topics of the run",
    ...
    accepting: "Writing…",
    accepted: "Written",
    stale: "The topics changed since the run began — better start over.",
    off: "The provider is off — the program-wide exam does not run.",
  },
  plan: {
    title: "Forecast",
    norm: "Daily budget",
