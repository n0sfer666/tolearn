...
export const en: Dictionary = {
  ...
  program: {
    ...
    deleteGoes:
      "The system trash takes the subprogram tree, progress, answers and clarifications, and the request log goes whole: it is shared by every program.",
    deleteRestore: "Until the trash is emptied, the system can put the program back.",
    deleteYes: "Delete",
    deleteNo: "Cancel",
    deleteBusy: "This program is being generated — wait for it or cancel it.",
    deleteSubprogram: "A subprogram cannot be deleted on its own — the whole program goes at once.",
    deleteLeft: "The trash refused part of it — some of the program data stayed on disk:",
    deleteCache: "The offline cache bindings stayed in place — the program was not deleted.",
    deleteBroken: "The program tree did not read correctly — the deletion was cancelled.",
    deleteGone: "This program is no longer in the library.",
    deleteFailed: "The deletion failed.",
    menu: "Program actions",
  },
  stage,
  generate,
  help,
